<template>
    <div class="mt-6 md:mt-0 sticky bg-black w-screen bottom-0 lg:h-screen lg:w-16 lg:fixed md:fixed lg:top-16">
       <div class="flex justify-around sm:-mt-2 mb-1 items-center lg:flex-col">
       <router-link v-for="page in pages" :key="page" :to=page.path >
       <div :class=" [current == page.name ? 'border-b-2 border-white text-white sm:mt-6 text-xs': 'text-gray-300 mt-5 text-sm']">
